...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    uint public constant TOTAL_SWAP_FEE_BPS = 120;
    uint public constant REWARD_SWAP_FEE_BPS = 90;
    uint public constant DEVELOPMENT_SWAP_FEE_BPS = 30;
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        uint balance0;
        uint balance1;
        { // scope for balance updates, avoids stack too deep errors
